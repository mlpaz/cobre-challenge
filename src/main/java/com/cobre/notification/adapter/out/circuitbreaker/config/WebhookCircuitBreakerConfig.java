...
import com.cobre.notification.adapter.out.circuitbreaker.WebhookCircuitBreakerJpaAdapter;
...
public class WebhookCircuitBreakerConfig {
	...
	@Bean
	public WebhookCircuitBreakerPort webhookCircuitBreakerPort(SubscriptionJpaRepository subscriptionRepository,
			WebhookCircuitBreakerJpaRepository repository, WebhookCircuitBreakerProperties properties,
			MetricsPort metricsPort) {
		return new WebhookCircuitBreakerJpaAdapter(subscriptionRepository, repository, properties, metricsPort);
	}
}
